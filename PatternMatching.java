...
//      String pattern3 = "[a-zA-Z0-9]";
    ...
    public static void findData(File _sourceFile,long fileNumber,Matcher _m3, String p1) throws FileNotFoundException,ArrayIndexOutOfBoundsException
    {
    	WebSearchEngine bfm = new WebSearchEngine();
    	//String filePath = FileUtils.readFileToString(_sourceFile);
